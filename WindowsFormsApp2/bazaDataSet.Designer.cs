...
namespace WindowsFormsApp2 {
    ...
    public partial class bazaDataSet : global::System.Data.DataSet {
        ...
        public partial class UzytkownicyDataTable : global::System.Data.TypedTableBase<UzytkownicyRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public UzytkownicyRow AddUzytkownicyRow(string imie, string nazwisko, string login, string haslo, string email) {
...
namespace WindowsFormsApp2.bazaDataSetTableAdapters {
    ...
    public partial class UzytkownicyTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Uzytkownicy] WHERE (([id_uzytkownika] = @Original_id_uzytkowni" +
                "ka) AND ([imie] = @Original_imie) AND ([nazwisko] = @Original_nazwisko) AND ([lo" +
                "gin] = @Original_login) AND ([haslo] = @Original_haslo) AND ([email] = @Original" +
                "_email))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Uzytkownicy] ([imie], [nazwisko], [login], [haslo], [email]) V" +
                "ALUES (@imie, @nazwisko, @login, @haslo, @email);\r\nSELECT id_uzytkownika, imie, " +
                "nazwisko, login, haslo, email FROM Uzytkownicy WHERE (id_uzytkownika = SCOPE_IDE" +
                "NTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Uzytkownicy] SET [imie] = @imie, [nazwisko] = @nazwisko, [login] = @login, [haslo] = @haslo, [email] = @email WHERE (([id_uzytkownika] = @Original_id_uzytkownika) AND ([imie] = @Original_imie) AND ([nazwisko] = @Original_nazwisko) AND ([login] = @Original_login) AND ([haslo] = @Original_haslo) AND ([email] = @Original_email));
SELECT id_uzytkownika, imie, nazwisko, login, haslo, email FROM Uzytkownicy WHERE (id_uzytkownika = @id_uzytkownika)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::WindowsFormsApp2.Properties.Settings.Default.bazaConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id_uzytkownika, imie, nazwisko, login, haslo, email FROM dbo.Uzytkownicy";
        ...
        public virtual int Fill(bazaDataSet.UzytkownicyDataTable dataTable) {
        ...
        public virtual bazaDataSet.UzytkownicyDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            bazaDataSet.UzytkownicyDataTable dataTable = new bazaDataSet.UzytkownicyDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(bazaDataSet.UzytkownicyDataTable dataTable) {
        ...
        public virtual int Delete(int Original_id_uzytkownika, string Original_imie, string Original_nazwisko, string Original_login, string Original_haslo, string Original_email) {
        ...
        public virtual int Insert(string imie, string nazwisko, string login, string haslo, string email) {
            if ((imie == null)) {
        ...
        public virtual int Update(string imie, string nazwisko, string login, string haslo, string email, int Original_id_uzytkownika, string Original_imie, string Original_nazwisko, string Original_login, string Original_haslo, string Original_email, int id_uzytkownika) {
            if ((imie == null)) {
                throw new global::System.ArgumentNullException("imie");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string imie, string nazwisko, string login, string haslo, string email, int Original_id_uzytkownika, string Original_imie, string Original_nazwisko, string Original_login, string Original_haslo, string Original_email) {
            return this.Update(imie, nazwisko, login, haslo, email, Original_id_uzytkownika, Original_imie, Original_nazwisko, Original_login, Original_haslo, Original_email, Original_id_uzytkownika);
        }
    }
